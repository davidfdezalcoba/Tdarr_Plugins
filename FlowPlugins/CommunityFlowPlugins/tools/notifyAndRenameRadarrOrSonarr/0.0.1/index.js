...
var details = function () { return ({
    ...
    description: 'Notify Radarr or Sonarr and apply the naming policy to a file.'
...
var plugin = function (args) { return __awaiter(void 0, void 0, void 0, function () {
    var lib, newPath, isSuccessful, arr, startup_delay, arr_host, arrHost, originalFileName, currentFileName, headers, arrApp, fInfo, error_1, previewRenameRequestResult, fileToRename, sourceFileSize, error_2, destinationSize;
    var _a, _b, _c, _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                args.jobLog("Refreshing and renaming ".concat(arrApp.name, "..."));
            ...
            case 2:
                ...
                _e.label = 3;
            case 3:
                if (!(fInfo.id !== '-1')) return [3 /*break*/, 18];
                _e.label = 4;
            case 4:
                _e.trys.push([4, 7, , 8]);
                return [4 /*yield*/, args.deps.axios({
            ...
            case 5:
                _e.sent();
                args.jobLog("\u2714 ".concat(arrApp.content, " '").concat(fInfo.id, "' refreshed in ").concat(arrApp.name, "."));
                args.jobLog("Waiting for ".concat(startup_delay, " seconds for the refresh to pick up."));
                return [4 /*yield*/, new Promise(function (f) { return setTimeout(f, startup_delay * 1000); })];
            case 6:
                _e.sent();
                return [3 /*break*/, 8];
            case 7:
                error_1 = _e.sent();
                args.jobLog("Could not refresh ".concat(arrApp.content, " '").concat(fInfo.id, "' in ").concat(arrApp.name, "."));
                args.jobLog(JSON.stringify(error_1));
                return [3 /*break*/, 8];
            case 8: return [4 /*yield*/, args.deps.axios({
                    method: 'get',
            ...
            case 9:
                ...
                if (!(fileToRename !== undefined)) return [3 /*break*/, 17];
            ...
            case 14:
                ...
                return [3 /*break*/, 15];
            case 15: return [4 /*yield*/, getSizeBytes(newPath)];
            case 16:
